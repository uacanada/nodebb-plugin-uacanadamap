<form id="acpPlaceSubCategory" class="uacanadamap-acp-bootbox">
  ...
  <input class="form-check-input" type="checkbox" value="on" name="isCategoryVisibleInAll" id="isCategoryVisibleInAll">
