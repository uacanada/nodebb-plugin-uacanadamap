...
Plugin.activate = async (data) => {
  ...
  if (!settingsExist) {
    try {
      ...
      newSettings.errorLog = 'Default settings file error '+error.toString();
    }
  }
  ...
  try {
    ...
    console.log(`Uacanadamap activate warning: `, error)
  }
...
Plugin.addRoutes = async ({ router, middleware, helpers }) => {
  ...
  console.log({MW:middleware.admin.checkPrivileges})




//   setupApiRoute(  router,"get",  "/uacanadamap/pluginsettings/flushsettings/:confirmation",
//   middlewares, // TODO
//   async (req, res) => {
//     console.log("API route /uacanadamap/pluginsettings/flushsettings/:confirmation was hit")
//     try {
//       const confirm = req.params.confirmation === "I%20confirm%20the%20deletion%20of%20settings"
...
setupApiRoute( router, "get", "/uacmp", [], async (req, res) => {
    console.log("API route /uacmp was hit")
   try {
     helpers.formatApiResponse(200, res, { message: "Test successful" });
   } catch (error) {
...
setupApiRoute(
  ...
  middlewares,
  (req, res) => {
    console.log("API route /map/resetsettings/ was hit")
   try {
     helpers.formatApiResponse(200, res, { message: "Test successful" });
   } catch (error) {
     console.log('Error:', error);
 ...
 setupApiRoute(
  ...
  "/map/addplace",
  async (req, res) => {
    console.log("API route /map/addplace was hit")
...
setupApiRoute(
  ...
  "/map/:method",
  async (req, res) => {
    console.log("API route /map/:method was hit")
