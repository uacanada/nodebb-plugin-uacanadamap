  ...
  try {
    ...
    if (mapFields?.placeTitle) {
      ...
      const altDescription = m.placeDescriptionAlt
        ...
        const btnClasses = 'nav-link badge rounded-pill text-bg-secondary me-2'
      ...
      const modifiedContent = `<nav class="placeTopicNav p-0 m-0 d-flex justify-content-between">
