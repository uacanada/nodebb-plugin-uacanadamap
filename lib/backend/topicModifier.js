  ...
  try {
    ...
    if (mapFields?.placeTitle) {
      ...
      <div id="metaTab" class="tab-content" data-authorcolor="${authorColor}" data-authoravatar="${authorAvatar}" data-authorname="${author.displayname || author.username}" data-authorletter="${authorLetter}">
        ...
        <div class="place-ctx-buttons d-flex justify-content-end p-2">
          <div class="place-ctx-buttons-wrapper">
          
          <div class="btn-group dropup me-2">
            <button type="button" title="Show contacts" class="btn circle-button dropdown-toggle text-bg-primary" data-bs-toggle="dropdown" aria-expanded="false"><i class="fa fa-solid fa-address-card"></i></buton> 
          ...
          <button type="button" title="Show address" class="btn circle-button dropdown-toggle text-bg-primary" data-bs-toggle="dropdown" aria-expanded="false"><i class="fa-solid fa-route"></i></buton> 
          <div class="dropdown-menu" data-popper-placement="top-end">
          ...
          <a href="/topic/${m.tid}"  title="Comment this" type="button" class="btn circle-button go-to-comment ms-2 text-bg-primary"><i class="fa-regular fa-comment-dots"></i></a>
          </div>
        </div>
        `;
