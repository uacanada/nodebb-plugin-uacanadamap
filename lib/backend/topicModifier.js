  ...
  try {
    ...
    if (mapFields?.placeTitle) {
      ...
      <nav id="placeTopicNav" class="pb-2 m-0">
        <div class="nav nav-pills" id="top-pills-tab" role="tablist">
            ${eventHtml.button}
            
            <button class="nav-link ${eventHtml.contactsClass} ${btnClasses}" 
                    id="navProfile-tab" 
                    data-bs-toggle="tab" 
            ...
            <button class="nav-link ${btnClasses}" 
                    id="navAddress-tab" 
                    data-bs-toggle="tab" 
      ...
      <div id="metaTab" class="tab-content" data-authorcolor="${authorColor}" data-authoravatar="${authorAvatar}" data-authorname="${author.displayname || author.username}" data-authorletter="${authorLetter}">
        ...
        <ul class="list-unstyled fs-6 list-group list-group-flush mb-5 p-0">
