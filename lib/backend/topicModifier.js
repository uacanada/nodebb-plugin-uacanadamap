  ...
  try {
    ...
    if (mapFields?.placeTitle) {
      ...
      <nav id="placeTopicNav" class="pb-2 m-0">
        ...
        <ul class="list-unstyled fs-6 list-group list-group-flush m-0 p-0" id="bottom-pills-tab" role="tablist">
              <li ${liAttrs}>
                  <a href="#" class="active" title="Show article" id="navDescription-tab" data-bs-target="#navDescription" ${btnAttrs} aria-controls="navDescription" aria-selected="true"><i class="fa fa-solid fa-circle-info"></i></a>
              </li>
              <li ${liAttrs}>
