  ...
  try {
    ...
    if (mapFields?.placeTitle) {
      ...
      <nav id="placeTopicNav" class="pb-2 m-0">
        ...
        <ul class="fs-6 list-group list-group-flush m-0 p-0" id="bottom-pills-tab" role="tablist">
              <li ${liAttrs}>
                  <a href="#" class="active ${btnClasses}" title="Show article" id="navDescription-tab" data-bs-target="#navDescription" ${btnAttrs} aria-controls="navDescription" aria-selected="true"><i class="fa fa-solid fa-circle-info"></i></a>
              </li>
              <li ${liAttrs}>
                  <a href="#" class="${btnClasses}" title="Show alternative lang" id="navAltDescription-tab" data-bs-target="#navAltDescription" ${btnAttrs} aria-controls="navAltDescription" aria-selected="false"><i class="fa-solid fa-language me-3"></i> ${settings.altContentTitle}</a>
              </li>
          </ul>
