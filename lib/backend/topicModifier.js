    ...
    if (mapFields?.placeTitle) {
      ...
      <div id="metaTab" class="tab-content" data-authorcolor="${authorColor}" data-authoravatar="${authorAvatar}" data-authorname="${author.displayname || author.username}" data-authorletter="${authorLetter}">
        ...
        <div class="place-ctx-buttons col-12 d-flex justify-content-end px-4 py-2">
          ...
          <div class="dropdown-menu show" data-popper-placement="top-end">
          ...
          <a href="/topic/${m.tid}"  title="Comment this" type="button" class="btn"><i class="fa-regular fa-comment-dots"></i></a>
          </div>
        </div>
        `;
