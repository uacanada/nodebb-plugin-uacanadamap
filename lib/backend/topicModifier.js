      ...
      const modifiedContent = `
        <nav class="p-0 m-0" style="white-space: normal;">
          <div class="nav nav-tabs" role="tablist">
            ${eventHtml.button}
            <button class="nav-link ${eventHtml.contactsClass}" id="navProfile-tab" data-bs-toggle="tab" data-bs-target="#navProfile" type="button" role="tab" aria-controls="navProfile" aria-selected="${eventHtml.contactsAriaSelected}">Contacts</button>
        ...
        <div id="metaTab" class="tab-content" style="white-space: normal;">
         
        ${eventHtml.tab}
         <div class="tab-pane fade mb-3 ${eventHtml.contactsClass}" id="navProfile" role="tabpanel" aria-labelledby="navProfile-tab" tabindex="0">
        ...
        <nav class="p-0 m-0 mt-3" style="white-space: normal;">
          <div class="nav nav-tabs" role="tablist">
            <button class="nav-link active" id="navDescription-tab" data-bs-toggle="tab" data-bs-target="#navDescription" type="button" role="tab" aria-controls="navDescription" aria-selected="true">About</button>
        ...
        <div id="descTab" class="tab-content" style="white-space: unset;">
          <div class="tab-pane fade mb-3 active" id="navDescription" role="tabpanel" aria-labelledby="navDescription-tab" tabindex="0">
