          ...
          <ul class="nav nav-pills" id="top-pills-tab" role="tablist">
             ${eventHtml.button} 
              <li class="nav-item" role="presentation">
                  <button class="nav-link ${eventHtml.contactsClass}" id="navProfile-tab" data-bs-toggle="pill" data-bs-target="#navProfile" type="button" role="tab" aria-controls="navProfile" aria-selected="${eventHtml.contactsAriaSelected}"><i class="fa fa-solid fa-address-card"></i></button>
              </li>
              <li class="nav-item" role="presentation">
