...
module.exports = (data, settings) => {
  try {
    ...
    if (mapFields?.placeTitle) {
      ...
      const eventHtml = {
        button:topicEventDiv?`<li class="nav-item" role="presentation"><button class="nav-link active" id="navEvent-tab" data-bs-toggle="pill" data-bs-target="#navEvent" type="button" role="tab" aria-controls="navEvent" aria-selected="true"><i class="fa fa-solid fa-calendar-day"></i></button></li>`:'',
      ...
      const modifiedContent = `<nav class="p-0 m-0 d-flex justify-content-between">
          <ul class="nav nav-pills" id="top-pills-tab" role="tablist">
             ${eventHtml.button} 
              <li class="nav-item" role="presentation">
                  <button class="nav-link ${eventHtml.contactsClass}" id="navProfile-tab" type="button" role="tab" data-bs-toggle="pill" data-bs-target="#navProfile" aria-controls="navProfile" aria-selected="${eventHtml.contactsAriaSelected}"><i class="fa fa-solid fa-address-card"></i></button>
              </li>
              <li class="nav-item" role="presentation">
                  <button class="nav-link" id="navAddress-tab" data-bs-toggle="pill" data-bs-target="#navAddress" type="button" role="tab" aria-controls="navAddress" aria-selected="false"><i class="fa fa-solid fa-map-location-dot"></i> Address</button>
              </li>
          </ul>
          <ul class="nav nav-pills" id="bottom-pills-tab" role="tablist">
              <li class="nav-item" role="presentation">
                  <button class="nav-link active" id="navDescription-tab" data-bs-toggle="pill" data-bs-target="#navDescription" type="button" role="tab" aria-controls="navDescription" aria-selected="true"><i class="fa fa-solid fa-circle-info"></i></button>
              </li>
              <li class="nav-item" role="presentation">
                  <button class="nav-link" id="navAltDescription-tab" data-bs-toggle="pill" data-bs-target="#navAltDescription" type="button" role="tab" aria-controls="navAltDescription" aria-selected="false"><i class="fa-solid fa-language me-3"></i> ${settings.altContentTitle}</button>
              </li>
          </ul>
      </nav>
