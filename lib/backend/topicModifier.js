...
module.exports = (data, settings) => {
  try {
    ...
    const eventCategoryLi = m.eventCategory ? `<li class="list-group-item">${(m.eventCategory) ? (m.eventCategoryName && m.eventCategoryName !== 'undefined') ? m.eventCategoryName : m.eventCategory : '' }</li>`:''
