  ...
  try {
    ...
    if (mapFields?.placeTitle) {
      ...
      const altDescription = m.placeDescriptionAlt
        ? `<p><i class="fa-solid fa-language me-3"></i> ${settings.altContentTitle}</p>${m.placeDescriptionAlt}`
        : "";
      ...
      const postAddon = `
        <nav class="p-0 m-0" style="white-space: normal;">
          <div class="nav nav-tabs" id="placeTopicTabs" role="tablist">
            <button class="nav-link active" id="navAbout-tab"   data-bs-toggle="tab" data-bs-target="#navAbout"   type="button" role="tab" aria-controls="navAbout"   aria-selected="true">About</button>
        ...
        <div class="tab-content" id="placeTopicTabst" style="white-space: normal;">
          <div class="tab-pane fade show active" id="navAbout" role="tabpanel" aria-labelledby="navAbout-tab" tabindex="0">
            ${topicEventDiv}
          </div>
          <div class="tab-pane fade" id="navProfile" role="tabpanel" aria-labelledby="navProfile-tab" tabindex="0">
            <ul class="list-group list-group-flush m-0 p-0">
              ${contactsList}
            </ul>
          </div>
          <div class="tab-pane fade" id="navAddress" role="tabpanel" aria-labelledby="navAddress-tab" tabindex="0">
              <ul class="list-group list-group-flush m-0 p-0">
              ${
                m.city
